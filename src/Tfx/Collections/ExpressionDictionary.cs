...
namespace Xyz.TForce.Collections
{
  ...
  public class ExpressionDictionary<TKey, TValue, TExpression> : DoubledDictionary<TKey, Expression<Func<TExpression, TValue>>>
  {

    public ExpressionDictionary()
      : base(null, new ExpressionComparer())
    {
    }


    public class ExpressionComparer
      : IEqualityComparer<Expression<Func<TExpression, TValue>>>
    {
